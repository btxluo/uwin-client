...
class Ui_LeftColumn(object):
    def setupUi(self, LeftColumn):
        ...
        self.btn_1_layout.setSpacing(5)
        ...
        self.radio_btn_widget = QWidget(self.menu_1)
        self.radio_btn_widget.setObjectName(u"radio_btn_widget")
        self.radio_btn_widget.setMinimumSize(QSize(0, 40))
        self.radio_btn_widget.setMaximumSize(QSize(16777215, 80))
        self.radio_btn_layout = QVBoxLayout(self.radio_btn_widget)
        self.radio_btn_layout.setSpacing(0)
        self.radio_btn_layout.setObjectName(u"radio_btn_layout")
        self.radio_btn_layout.setContentsMargins(0, 0, 0, 0)

        self.verticalLayout.addWidget(self.radio_btn_widget)
        ...
        self.label_vip_date = QLabel(self.menu_1)
        self.label_vip_date.setObjectName(u"label_timeout")
        self.label_vip_date.setMinimumSize(QSize(0, 40))
        self.label_vip_date.setMaximumSize(QSize(16777215, 40))
        a_font = QFont()
        a_font.setPointSize(16)
        self.label_vip_date.setFont(a_font)
        self.label_vip_date.setStyleSheet(u"font-size: 10pt")
        self.label_vip_date.setAlignment(Qt.AlignCenter)
        self.verticalLayout.addWidget(self.label_vip_date)
    ...
    def retranslateUi(self, LeftColumn):
        ...
        # self.label_1.setText(QCoreApplication.translate("LeftColumn", u"display qrCode", None))
        # self.label_vip_date.setText(QCoreApplication.translate("LeftColumn", u"pls charge in 15min", None))
        self.label_2.setText(QCoreApplication.translate("LeftColumn", u"请查看帮助文档", None))
        path = os.getcwd()
        self.label_3.setText(QCoreApplication.translate(
            "LeftColumn", f'<a href="file:///%s/help/帮助文档.mht" style="color:#0000ff;"><b> 帮助文档 </b></a>' % path, None))
