...
# MAIN FUNCTIONS
# ///////////////////////////////////////////////////////////////
from .functions_register_window import *
...
class SetupRegisterWindow:
    ...
    def setup_gui(self):
        # APP TITLE
        # ///////////////////////////////////////////////////////////////
        self.setWindowTitle("新用户注册/忘记密码")
        ...
        # ///////////////////////////////////////////////////////////////
        # ADD MENUS
        # self.ui.left_menu.add_menus(SetupRegisterWindow.add_left_menus)
        ...
        # ADD Title
        self.ui.title_bar.set_title("新用户注册/忘记密码")
        ...
        # self.ui.load_pages.logo_layout.addWidget(self.label_1)
        ...
        self.ui.load_pages.page_2_layout.addWidget(self.label_1)
        self.ui.load_pages.row_1_layout.addWidget(self.line_edit_1)
